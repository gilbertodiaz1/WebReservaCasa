...
class BookingProcess
{
	...
	private function setMyRequestParams(){ 
		...
		$bsiCore->wLog('Datos recibidos paso 4 Reserva ' . '[Fecha de llegada]=' . $this->checkInDate . '[Fecha de salida]=' . $this->checkOutDate . '[Cantidad de personas]=' . $this->guestsPerRoom,$bsiCore::INFO,session_id());
		$bsiCore->wLog('Datos recibidos paso 4 Cliente ' . '[title]=' . $this->clientdata['title'] . '[fname]=' . $this->clientdata['fname'] . '[lname]=' . $this->clientdata['lname'] . '[address]=' . $this->clientdata['address'] . '[city]=' . $this->clientdata['city'] . '[state]=' . $this->clientdata['state'] . '[zipcode]=' . $this->clientdata['zipcode'] . '[country]=' . $this->clientdata['country'] . '[phone]=' . $this->clientdata['phone'] . '[fax]=' . $this->clientdata['fax'] . '[email]=' . $this->clientdata['email'] . '[password]=' . $this->clientdata['password'] . '[id_type]=' . $this->clientdata['id_type'] . '[id_number]=' . $this->clientdata['id_number'] . '[message]=' . $this->clientdata['message'] . '[clientip]=' . $this->clientdata['clientip'] . '[paymentGatewayCode]=' . $this->paymentGatewayCode,$bsiCore::INFO,session_id());
		$bsiCore->wLog('Datos adicinales del proceso paso 4 ' . '[bookingId]=' . $this->bookingId . '[expTime]=' . $this->expTime . '[currencySymbol]=' . $this->currencySymbol . '[taxPercent]=' . $this->taxPercent . '[clientName]=' . $this->clientName . '[clientEmail]=' . $this->clientEmail . '[noOfRooms]=' . $this->noOfRooms . '[taxWithPrice]=' . $this->taxWithPrice,$bsiCore::INFO,session_id());
	...
	private function removeSessionVariables(){
		...
		$bsiCore->wLog('Se remueven las variables de session',$bsiCore::INFO,session_id());
	}
	...
	private function saveClientData(){
		...
		$bsiCore->wLog('Se comprobo si el cliente existia ' . '[clientId]=' . $this->clientId . '[email]=' .$this->clientdata['email'],$bsiCore::INFO,session_id());
		if(mysql_num_rows($sql1) > 0){
			...
			$bsiCore->wLog('Cliente ya existe en el sistema, actualizando sus datos ' . '[title]=' . $this->clientdata['title'] . '[fname]=' . $this->clientdata['fname'] . '[lname]=' . $this->clientdata['lname'] . '[address]=' . $this->clientdata['address'] . '[city]=' . $this->clientdata['city'] . '[state]=' . $this->clientdata['state'] . '[zipcode]=' . $this->clientdata['zipcode'] . '[country]=' . $this->clientdata['country'] . '[phone]=' . $this->clientdata['phone'] . '[fax]=' . $this->clientdata['fax'] . '[email]=' . $this->clientdata['email'] . '[password]=' . $this->clientdata['password'] . '[id_type]=' . $this->clientdata['id_type'] . '[id_number]=' . $this->clientdata['id_number'] . '[message]=' . $this->clientdata['message'] . '[clientip]=' . $this->clientdata['clientip'],$bsiCore::INFO,session_id());
			...
			$bsiCore->wLog('Guardando datos del cliente por primera vez ' . '[title]=' . $this->clientdata['title'] . '[fname]=' . $this->clientdata['fname'] . '[lname]=' . $this->clientdata['lname'] . '[address]=' . $this->clientdata['address'] . '[city]=' . $this->clientdata['city'] . '[state]=' . $this->clientdata['state'] . '[zipcode]=' . $this->clientdata['zipcode'] . '[country]=' . $this->clientdata['country'] . '[phone]=' . $this->clientdata['phone'] . '[fax]=' . $this->clientdata['fax'] . '[email]=' . $this->clientdata['email'] . '[password]=' . $this->clientdata['password'] . '[id_type]=' . $this->clientdata['id_type'] . '[id_number]=' . $this->clientdata['id_number'] . '[message]=' . $this->clientdata['message'] . '[clientip]=' . $this->clientdata['clientip'],$bsiCore::INFO,session_id());
		}
	...
	private function saveBookingData(){
		...
		foreach($this->reservationdata as $revdata){
			...
			$sql = mysql_query("INSERT INTO bsi_reservation (bookings_id, room_id, room_type_id) values(".$this->bookingId.",  ".$rooms['roomid'].", ".$revdata['roomtypeid'].")");
				$bsiCore->wLog('Se guarda la reserva de la casa tabla reservation' . '[bookingId]=' . $this->bookingId . '[roomid]=' .$rooms['roomid']. '[roomtypeid]=' .$revdata['roomtypeid'],$bsiCore::INFO,session_id());
			} 
		}
	}	
